...
_CmapData = dict[Literal["red", "green", "blue", "alpha"], Sequence[tuple[float, ...]]]

_saturated_red_blue_data: _CmapData = {
...
saturated_red_blue_cmap = LinearSegmentedColormap("SaturatedRdBu", _saturated_red_blue_data)


_saturated_just_sky_data: _CmapData = {
...
saturated_just_sky_cmap = LinearSegmentedColormap("SaturatedJSky", _saturated_just_sky_data)


_saturated_sky_data: _CmapData = {
...
saturated_sky_cmap = LinearSegmentedColormap("SaturatedSky", _saturated_sky_data)
