...
saturated_red_blue_data: _CmapData = {
...
saturated_red_blue_cmap = LinearSegmentedColormap("SaturatedRdBu", saturated_red_blue_data)


saturated_just_sky_data: _CmapData = {
...
saturated_just_sky_cmap = LinearSegmentedColormap("SaturatedJSky", saturated_just_sky_data)


saturated_sky_data: _CmapData = {
...
saturated_sky_cmap = LinearSegmentedColormap("SaturatedSky", saturated_sky_data)
