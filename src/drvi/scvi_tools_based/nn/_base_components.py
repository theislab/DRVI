        ...
        **kwargs,
        ...
        for param_name, param_info in params_for_likelihood.items():
            if param_info.startswith("fixed="):
                ...
                if covariate_modeling_strategy in ["one_hot", "one_hot_linear", "emb", "emb_linear"]:
                    ...
                    params_nets[param_name] = nn.Linear(categorical_covariate_dims[0], n_output, bias=True)
                else:
                    raise NotImplementedError()
            else:
