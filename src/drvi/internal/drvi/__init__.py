...
.. warning::
    ...
    Everything in :mod:`drvi.internal.drvi` is for **DRVI development only** and may change or be
    removed without notice. For general use, import the maintained model as ``scvi.external.DRVI``
